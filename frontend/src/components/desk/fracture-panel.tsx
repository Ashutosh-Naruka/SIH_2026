...
// Declared once and reused across every render branch below (no data, no
// chokepoints, populated) -- these used to be three separately hand-typed
// copies of nearly the same two sentences, which drifted out of step with
// each other in length and left the ⓘ hover saying something slightly
// different depending on which state a reader happened to land on.
const HINT =
  'A combined 0–100 disruption score per chokepoint: real PortWatch transit anomaly, GDELT ' +
  'conflict-coverage anomaly, and Joint War Committee listing, fused. Fewer than the full signal ' +
  'set caps the score at "Watch," however high its raw index.'
