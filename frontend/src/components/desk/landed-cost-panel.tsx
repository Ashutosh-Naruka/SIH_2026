...
import { cleanDashes, componentLabel, humanizeReason, wasRewritten } from '@/lib/humanize'
      ...
      <div className="flex min-w-0 flex-col">
        ...
        {usdPerMt == null && (
          <span
            ...
            title={wasRewritten(reason) ? cleanDashes(reason) : undefined}
          >
    ...
    >
      <div>
        <ComponentRow
          ...
          reason=""
          title="One component of the total, not Fleet Mix's $/mt (the chosen vessel's cost) or Rate Forecast's $/mt (today's open-market class quote, before any vessel is chosen)."
        />
        <ComponentRow
          label="Wait / delay"
