import { ALL_VIEWS, type DeskView } from '@/lib/nav'
...
// Taken from the navigation rather than restated here. When these were two
// separate lists, adding a screen to one and forgetting the other produced a
// link the app writes and then refuses to parse.
const VIEWS: readonly DeskView[] = ALL_VIEWS
